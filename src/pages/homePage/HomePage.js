               ...
               <div className='imgdiv'><img src={itfLogo} alt='logo'/></div>
                  ...
                  <Link to="/login" className="links">
                    <div className='logdiv'>
                     <CustomButton className="login" title= "Log In" backgroundColor={"transparent"} borderRadius={20} width={350} height={80} fontSize={26} box-shadow = 'none' border = '2px solid white' onClick={()=> console.log("clicked")}/>
                    </div>
                  </Link>
